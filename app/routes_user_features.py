...
def user_rental_applications():
    ...
    try:
        ...
        cur.execute("""
            ...
            JOIN prediksi_sewa_bulanan p ON ra.property_id = p.id
            WHERE ra.user_id = %s
    ...
    try:
        ...
        cur.execute("""
            SELECT 
                ...
                h.created_at
            FROM histori_sewa h
            LEFT JOIN prediksi_sewa_bulanan p ON h.aset_id = p.id AND h.jenis_aset = 'tanah'
            WHERE h.user_id = %s
    ...
    try:
        ...
        cur.execute("""
            SELECT 
                ...
                kamar_mandi,
                jumlah_lantai,
                harga_sewa_ensemble as harga_prediksi,
                harga_sewa_ensemble as harga_sewa,
                status_kirim_user as status,
                created_at
            FROM prediksi_sewa_bulanan
            WHERE status_kirim_user = 'pending'
            ORDER BY created_at DESC
        """)
